...
QT_MOC_LITERAL(1, 12, 7), // "unPause"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4), // "save"
QT_MOC_LITERAL(4, 26, 4), // "load"
QT_MOC_LITERAL(5, 31, 7), // "endGame"
QT_MOC_LITERAL(6, 39, 10), // "showWindow"
QT_MOC_LITERAL(7, 50, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(8, 72, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(9, 96, 23) // "on_pushButton_3_clicked"

    },
    "PauseWidget\0unPause\0\0save\0load\0endGame\0"
    "showWindow\0on_pushButton_clicked\0"
...
void PauseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PauseWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseWidget::unPause)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PauseWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseWidget::save)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PauseWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseWidget::load)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (PauseWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseWidget::endGame)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void PauseWidget::unPause()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void PauseWidget::save()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void PauseWidget::load()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void PauseWidget::endGame()
{
